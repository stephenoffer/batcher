...
def greatest_least_single_arg(node: SchemaNode, _ctx: OptimizerContext) -> LogicalPlan | None:
...
def greatest_least_flatten_nested(node: SchemaNode, _ctx: OptimizerContext) -> LogicalPlan | None:
...
def greatest_least_dedup_args(node: SchemaNode, _ctx: OptimizerContext) -> LogicalPlan | None:
...
def greatest_least_fold_literals(node: SchemaNode, _ctx: OptimizerContext) -> LogicalPlan | None:
