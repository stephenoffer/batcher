...
@rule(name="drop_is_null_on_non_nullable_column", phase=Phase.NORMALIZE, matches=_EXPR_NODES)
...
@rule(name="drop_is_not_null_on_non_nullable_column", phase=Phase.NORMALIZE, matches=_EXPR_NODES)
...
@rule(name="drop_coalesce_of_non_nullable_first_arg", phase=Phase.NORMALIZE, matches=_EXPR_NODES)
...
@rule(name="drop_coalesce_args_after_non_nullable", phase=Phase.NORMALIZE, matches=_EXPR_NODES)
