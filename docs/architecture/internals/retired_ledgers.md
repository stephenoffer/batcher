...
| Architecture audit | `docs/architecture/internals/audit_ledger.md` |
| Defect hunt | `docs/architecture/internals/bug_hunt_ledger.md` |
| Daft parity | `docs/architecture/internals/daft_parity_ledger.md` |
| Decision quality | `docs/architecture/internals/decision_quality_ledger.md` |
| Engine improvements | `docs/architecture/internals/engine_improvements_ledger.md` |
| Estimator mathematics | `docs/architecture/internals/math_improvements_ledger.md` |
| Spill / OOM | `docs/architecture/internals/spill_oom_improvements_ledger.md` |
| Streaming improvements | `docs/architecture/internals/streaming_improvements_ledger.md` |
| UDF improvements | `docs/architecture/internals/udf_improvements_ledger.md` |
