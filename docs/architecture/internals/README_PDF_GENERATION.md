...
1. Open the HTML file in your browser:
   ```
   file:///home/ray/default_cld_g54aiirwj1s8t9ktgzikqur41k/batcher/docs/architecture/internals/mathematical_foundations.html
   ```
...
### Generate PDF:
```bash
cd /home/ray/default_cld_g54aiirwj1s8t9ktgzikqur41k/batcher/docs/architecture/internals
...
```bash
docker run --rm \
    -v /home/ray/default_cld_g54aiirwj1s8t9ktgzikqur41k/batcher/docs/architecture/internals:/data \
    pandoc/latex:latest \
