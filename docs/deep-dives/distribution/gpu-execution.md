...
- {doc}`Tensor columns </deep-dives/memory/tensor-columns>`: what crosses into the model.
- {doc}`Distributed scheduling </deep-dives/distribution/distributed-scheduling>`: how the actors get placed.
