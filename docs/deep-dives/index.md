...
:link-type: doc
Re-planning mid-query on measured cardinalities. The part with no equivalent elsewhere.
:::
...
- [Aggregation internals](aggregation-internals.md)
- [Join algorithms](join-algorithms.md)
- [Sort internals](sort-internals.md)
- [Window internals](window-internals.md)
...
- [The buffer pool](buffer-pool.md)
...
- [Distributed scheduling](distributed-scheduling.md)
- [GPU execution](gpu-execution.md)

## The adaptive layer

This is the part with no equivalent in DuckDB or Spark, and it is the part worth reading if
you want to know what Batcher is actually for.
