...
- {doc}`/user-guide/transform/columns/string-accessor`: the guide these methods are the reference for.
- {doc}`/cookbook/expressions/strings/index`: runnable recipes for searching, reshaping, and measuring text.
