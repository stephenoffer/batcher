...
On {py:class}`.list <batcher.plan.expr_ir.namespaces.collections._ListNamespace>`: {py:meth}`.dim() <batcher.plan.expr_ir.namespaces.collections._ListNamespace.dim>` (the embedding dimension),
