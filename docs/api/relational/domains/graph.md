...
To learn these rather than look them up, start with {doc}`/user-guide/analyze/domains/graphs`.
...
- {doc}`/user-guide/analyze/domains/graphs`: the guide that teaches these.
