...
- {doc}`/getting-started/tutorials/paths/platform-engineer`: the operational half, once the pipelines exist.
- {doc}`Building a lakehouse </getting-started/tutorials/pipelines/building-a-lakehouse>`: the same pieces, end to end.
