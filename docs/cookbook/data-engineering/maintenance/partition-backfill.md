...
- {doc}`Late-arriving data </cookbook/data-engineering/ingest/late-arriving-data>`: why the day needed rebuilding in the
  first place.
- {doc}`Slowly changing dimensions </cookbook/data-engineering/modeling/slowly-changing-dimensions>`: when history is the
