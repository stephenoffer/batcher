...
number you get back names a cell *center* while you were reasoning about corners.
...
Deciding which is a modeling question, not a query question. Do decide, though, rather than
