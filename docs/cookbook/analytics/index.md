...
{doc}`/cookbook/analytics/analytics-query` runs aggregate, join, and window over one small orders table,
...
```{toctree}
:hidden:
:caption: Aggregation and ranking
