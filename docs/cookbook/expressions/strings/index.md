...
Fourteen recipes over the `.str` accessor, in three groups: changing what a value looks like, finding something inside it, and turning it into a number or a key.
