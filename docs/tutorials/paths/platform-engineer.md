...
:::{seealso}
- {doc}`Optimizing a slow query </tutorials/foundations/optimizing-a-slow-query>`: a real diagnosis, start to finish.
...
- {doc}`/tutorials/paths/data-engineer`: the pipelines you are operating.
