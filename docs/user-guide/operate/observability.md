...
- {doc}`Explain plans </user-guide/operate/explain-plans>`: reading a plan before you run it.
- {doc}`Performance </user-guide/operate/performance>`: turning what you saw here into a faster query.
- {doc}`Troubleshooting </user-guide/operate/troubleshooting>`: symptom-first debugging.
