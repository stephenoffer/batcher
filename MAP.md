...
| `groupby.py` | 1068 | `GroupBy` — an in-progress grouped aggregation produced by `Dataset.group_by`. |
...
| `core.py` | 6796 | The scalar expression base class and its core IR nodes. |
