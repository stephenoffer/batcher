...
Covering 1477 Python modules across 216 packages and 294 Rust files across 15 crates.
...
| `groupby.py` | 951 | `GroupBy` — an in-progress grouped aggregation produced by `Dataset.group_by`. |
