...
pub mod placement;
pub use placement::{cpu_for_worker, pinning_order};

pub mod topology;
pub use topology::{
    affinity_cpus, numa_node_cpus, prefetch_read, prefetch_read_l2, prefetch_slice_ahead,
    CachePadded, CpuTopology, DEFAULT_CACHE_LINE, MAX_RADIX_BITS, MIN_RADIX_BITS,
};
